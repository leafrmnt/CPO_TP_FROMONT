...
public class GrilleDeJeu {
    ...
    /**
     * vérifie si toutes les cellules de la grille sont éteintes, renvoit
     * true=toutes éteintes false= pas toutes éteintes
     *
     * @return
     */
    ...
    /**
     * active une cellule aléatoirement
     * @param nombreCellules
     */
    public void reinitialiserCellulesAleatoires(int nombreCellules) {
    ...
    /**
     * active une ligne aléatoirement
     */
    public void activerLigneAleatoire() {
        int ligneAleatoire = (int) (Math.random() * nbLignes) % nbLignes;
        activerLigneDeCellules(ligneAleatoire);
    }
}
